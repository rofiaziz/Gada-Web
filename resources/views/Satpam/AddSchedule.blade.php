...
@section('Title')
    <title>GadaMaxima - Tambah Jadwal Satpam</title>
@endsection
@section('ExtraFont')
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 ">
                              <div class="form-group">
                                ...
                                <input type="text" name="bulan" class="form-control" placeholder="Dalam Angka">
                                  @if($errors->has('bulan'))
                                  <div class="text-danger">
                                      {{ $errors->first('bulan')}}
                                  </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="shift" class="form-control" placeholder="Shift pagi">
                                    @if($errors->has('shift'))
                                    <div class="text-danger">
                                            {{ $errors->first('shift')}}
                                     </div>
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="time" name="time1" class="form-control" placeholder="">
                                    @if($errors->has('time1'))
                                    <div class="text-danger">
                                            {{ $errors->first('time1')}}
                                     </div>
