              ...
              <div class="col-md-8 offset-md-2">
                  <div class="card card-user">
                    ...
                    <div class="card-body">
                      ...
                      <form method="post" action="/Package/Addpackage/">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 ">
                              <div class="form-group">
                                ...
                                <input type="date" name="Nama Paket" class="form-control" placeholder="">
                                  @if($errors->has('Nama Paket'))
                                  <div class="text-danger">
                                      {{ $errors->first('Nama Paket')}}
                                  </div>
                                  @endif
                              </div>
                            </div>
                            ...
                            <div class="col-md-6 ">
                              <div class="form-group">
                                ...
                                <input type="text" name="Batas Satpam" class="form-control" placeholder="Dalam Angka">
                                  @if($errors->has('Batas Satpam'))
                                  <div class="text-danger">
                                      {{ $errors->first('Batas Satpam')}}
                                  </div>
                                  @endif
                              </div>
                            </div>
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <textarea name="Detail" class="form-control" id="" cols="30" rows="10" placeholder="">
                                </textarea>
