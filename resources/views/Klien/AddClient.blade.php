...
<div class="row">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6"><h3 class="m-b-35" style="font-family: 'Abril Fatface'; font-size:35px;">Tambah Klien</h3>
            </div>
            {{-- <div class="col-md-6">
              ...
              <div class="col-md-8 offset-md-2">
                  <div class="card card-user">
                    <div class="card-header">
                      <h5 class="card-title" style="text-align:center">Tambah Klien Baru</h5>
                    </div>
                    <div class="card-body">
                      <form>
                        ...
                        <div class="row">
                          <div class="col-md-12 ">
                            <div class="form-group">
                              <h6 label>Nama Perusahaan</label>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <h6 label>Nomor MoU</label>
                              <input type="text" class="form-control" placeholder="MoU">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <h6 label>Kontak</label>
                              <input type="number" class="form-control" placeholder="081xxx" maxlength="25">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <h6 label>Alamat Lengkap</label>
